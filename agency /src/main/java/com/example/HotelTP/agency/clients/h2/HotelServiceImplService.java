 ...
 * 
 */
@WebServiceClient(name = "HotelServiceImplService", targetNamespace = "http://service.server.HotelSOAP.example.com/", wsdlLocation = "http://localhost:8083/hotelservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HOTELSERVICEIMPLSERVICE_QNAME = new QName("http://service.server.HotelSOAP.example.com/", "HotelServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8083/hotelservice?wsdl");
    ...
    public HotelService getHotelServiceImplPort() {
        return super.getPort(new QName("http://service.server.HotelSOAP.example.com/", "HotelServiceImplPort"), HotelService.class);
    }
    ...
    public HotelService getHotelServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.server.HotelSOAP.example.com/", "HotelServiceImplPort"), HotelService.class, features);
    }
