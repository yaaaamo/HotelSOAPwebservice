 ...
 * 
 */
@WebServiceClient(name = "HotelServiceImplService", targetNamespace = "http://service.server.HotelSOAP.example.com/", wsdlLocation = "http://localhost:8080/hotelservice?wsdl")
