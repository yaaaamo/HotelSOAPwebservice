 ...
 * 
 */
@WebServiceClient(name = "AgencyServiceImplService", targetNamespace = "http://service.agency.HotelTP.example.com/", wsdlLocation = "http://localhost:9093/agencyservice?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9093/agencyservice?wsdl");
